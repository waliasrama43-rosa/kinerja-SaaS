...
// ====================================================================
// UTILITAS QRIS DINAMIS (GENERATIF) — Konversi QRIS Statis → Dinamis
// ====================================================================
...
function tesQrisDinamis() {
  ...
  var statis  = (cfg.QRIS_STATIS && cfg.QRIS_STATIS.toString().indexOf("0002") === 0)
                ? cfg.QRIS_STATIS : SAAS_CONFIG.QRIS_STATIS_PAYLOAD;
